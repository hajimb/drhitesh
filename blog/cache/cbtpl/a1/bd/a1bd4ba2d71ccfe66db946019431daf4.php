<article id="p<?php echo context::global_filters($_ctx->posts->post_id,array (
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryID'); ?>" class="post short <?php echo (($_ctx->posts->index()+1)%2 ? "odd" : ""); ?> <?php if ($_ctx->posts->index() == 0) { echo 'first'; } ?>" lang="<?php if ($_ctx->posts->post_lang) { echo context::global_filters($_ctx->posts->post_lang,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
	...
	<?php if($_ctx->posts->isExtended()) : ?>
		<div class="post-content">
			<?php echo context::EntryFirstImageHelper('t',0,'post-icon',0,0,0); ?>
			<?php echo context::global_filters($_ctx->posts->getExcerpt(0),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
		...
		<p class="post-read-it"><a href="<?php echo context::global_filters($_ctx->posts->getURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
	...
	<?php if(!$_ctx->posts->isExtended()) : ?>
		<div class="post-content">
			<?php echo context::EntryFirstImageHelper('t',0,'post-icon',0,0,0); ?>
			<p>
				<?php echo context::global_filters($_ctx->posts->getContent(0),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => '300',
  ...
  'strip_tags' => 0,
				...
				<?php if (strlen(context::global_filters($_ctx->posts->getContent(0),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => '0',
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryIfContentCut')) > strlen(context::global_filters($_ctx->posts->getContent(0),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => '300',
