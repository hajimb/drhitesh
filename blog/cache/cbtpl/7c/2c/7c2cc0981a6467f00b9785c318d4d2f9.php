<article id="p<?php echo context::global_filters($_ctx->posts->post_id,array (
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryID'); ?>" class="post <?php echo (($_ctx->posts->index()+1)%2 ? "odd" : ""); ?> <?php if ($_ctx->posts->index() == 0) { echo 'first'; } ?> full" lang="<?php if ($_ctx->posts->post_lang) { echo context::global_filters($_ctx->posts->post_lang,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
