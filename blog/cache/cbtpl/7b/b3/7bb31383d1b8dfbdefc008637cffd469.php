...
<?php while ($_ctx->comments->fetch()) : ?>
  ...
  'strip_tags' => 0,
		...
		<?php endif; ?>
					<?php if(!$_ctx->comments->comment_trackback) : ?>
						<li id="c<?php echo $_ctx->comments->comment_id; ?>" class="comment <?php if ($_ctx->comments->isMe()) { echo 'me'; } ?> <?php echo (($_ctx->comments->index()+1)%2 ? "odd" : ""); ?> <?php if ($_ctx->comments->index() == 0) { echo 'first'; } ?>">
					<?php endif; ?>
					<?php if($_ctx->comments->comment_trackback) : ?>
						<li id="c<?php echo $_ctx->pings->comment_id; ?>" class="ping <?php echo (($_ctx->pings->index()+1)%2 ? "odd" : ""); ?> <?php if ($_ctx->pings->index() == 0) { echo 'first'; } ?>">
					<?php endif; ?>
							<p class="comment-info"><a href="#c<?php echo $_ctx->comments->comment_id; ?>" class="comment-number"><?php echo $_ctx->comments->index()+1; ?></a>
								<?php echo __('From'); ?> <?php echo context::global_filters($_ctx->comments->getAuthorLink(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'CommentAuthorLink'); ?> - <time datetime="<?php echo context::global_filters($_ctx->comments->getISO8601Date(''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'iso8601' => '1',
),'CommentDate'); ?>"><?php echo context::global_filters($_ctx->comments->getDate('%d',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'format' => '%d',
),'CommentDate'); ?>/<?php echo context::global_filters($_ctx->comments->getDate('%m',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'format' => '%m',
),'CommentDate'); ?>/<?php echo context::global_filters($_ctx->comments->getDate('%Y',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php if($_ctx->posts->commentsActive()) : ?>
	...
	<form class="comment-form" action="<?php echo context::global_filters($_ctx->posts->getURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
		...
		<?php if ($_ctx->comment_preview !== null && $_ctx->comment_preview["preview"]) : ?>
			<div id="pr">
				...
				<div class="comment-preview"><?php echo context::global_filters($_ctx->comment_preview["content"],array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<p class="field field-content"><label for="c_content"><?php echo __('Comment'); ?><abbr title="<?php echo __('Required field'); ?>">*</abbr>&nbsp;:</label>
				<textarea name="c_content" id="c_content" cols="35"
				 rows="7" required aria-describedby="c_help"><?php echo context::global_filters($_ctx->comment_preview["rawcontent"],array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
