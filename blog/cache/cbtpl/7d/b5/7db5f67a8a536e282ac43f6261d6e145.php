...
<?php while ($_ctx->archives->fetch()) : ?><link rel="next" href="<?php echo context::global_filters($_ctx->archives->url($core),array (
  ...
  'strip_tags' => 0,
	...
	<?php
if (!isset($params)) $params = [];$params['type'] = 'month';
...
<?php while ($_ctx->archives->fetch()) : ?><a href="<?php echo context::global_filters($_ctx->archives->url($core),array (
  ...
  'strip_tags' => 0,
		...
		<?php echo context::global_filters(dt::dt2str('%B %Y',$_ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while ($_ctx->archives->fetch()) : ?> - <a href="<?php echo context::global_filters($_ctx->archives->url($core),array (
  ...
  'strip_tags' => 0,
	...
	<header id="content-info">
		<h2>
			<time datetime="<?php echo context::global_filters(dt::dt2str('%Y-%m',$_ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'format' => '%Y-%m',
),'ArchiveDate'); ?>"><?php echo context::global_filters(dt::dt2str('%B %Y',$_ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?></time> <span>(<?php echo context::global_filters($_ctx->archives->nb_post,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
