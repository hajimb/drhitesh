...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xml:lang="<?php echo context::global_filters($core->blog->settings->system->lang,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while ($_ctx->posts->fetch()) : ?>
  ...
  'strip_tags' => 0,
			...
			<link href="<?php echo context::global_filters($_ctx->posts->getURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryURL'); ?>" rel="alternate" type="text/html" title="<?php echo context::global_filters($_ctx->posts->post_title,array (
  0 => NULL,
  'encode_xml' => ' 1 ',
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<id><?php echo context::global_filters($_ctx->posts->getFeedID(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<published><?php echo context::global_filters($_ctx->posts->getISO8601Date(''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'iso8601' => '1',
			...
			<?php if((boolean)$_ctx->posts->isRepublished()) : ?>
				<updated><?php echo context::global_filters($_ctx->posts->getISO8601Date('upddt'),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'upddt' => '1',
			...
			<?php endif; ?>
			<?php if(!(boolean)$_ctx->posts->isRepublished()) : ?>
				<updated><?php echo context::global_filters($_ctx->posts->getISO8601Date(''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'iso8601' => '1',
			...
			<?php endif; ?>
			<author>
				<name><?php echo context::global_filters($_ctx->posts->getAuthorCN(),array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<?php if($_ctx->posts->cat_id) : ?>
				<dc:subject><?php echo context::global_filters($_ctx->posts->cat_title,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
...
$_ctx->meta = $core->meta->getMetaRecordset($_ctx->posts->post_meta,'tag'); $_ctx->meta->sort('meta_id_lower','asc'); ?><?php while ($_ctx->meta->fetch()) : ?>
				<dc:subject><?php echo context::global_filters($_ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<content type="html"><?php echo context::global_filters($_ctx->posts->getExcerpt(1),array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'absolute_urls' => '1',
),'EntryExcerpt'); ?> <?php echo context::global_filters($_ctx->posts->getContent(1),array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php foreach ($_ctx->attachments as $attach_i => $attach_f) : $GLOBALS['attach_i'] = $attach_i; $GLOBALS['attach_f'] = $attach_f;$_ctx->file_url = $attach_f->file_url; ?>
				<link rel="enclosure" href="<?php echo context::global_filters($attach_f->file_url,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'AttachmentURL'); ?>" length="<?php echo context::global_filters($attach_f->size,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
			...
			<?php if($_ctx->posts->commentsActive()) : ?>
				<wfw:comment><?php echo context::global_filters($_ctx->posts->getURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
				...
				<wfw:commentRss><?php echo context::global_filters($core->blog->url.$core->url->getURLFor("feed","atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
