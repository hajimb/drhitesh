...
class Online extends CI_Controller {	
	...
	public function index($param=''){
	    ...
	    $page_data['master_medical_history'] = $this->createdropdown('medical_history[]',0,'html','disease','','class="medicalhistory smart-select2"','multiple="multiple"');
	    $page_data['master_exercise'] 		 = $this->createdropdown('exercise[]',0,'html','exercise','','class="exercise smart-select2"','multiple="multiple"');
	    $page_data['master_habits'] 		 = $this->createdropdown('habits[]',0,'html','habits','','class="habits smart-select2"','multiple="multiple"');
	    $page_data['master_allergy'] 		 = $this->createdropdown('allergy[]',0,'html','allergy','','class="allergy smart-select2"','multiple="multiple"');
	    // if()
	    $page_data['id'] 		 = $id->id;
	...
	public function createdropdown($display,$id,$format,$table,$select,$class='',$multiple=''){
		//echo $select;
