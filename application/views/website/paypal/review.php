...
<head>
    <meta charset="utf-8">
    <title>Angell EYE - PayPal CodeIgniter Library Demo - Express Checkout - Review Order</title>
            ...
            <table class="table table-bordered">
                ...
                foreach($cart['shopping_cart']['items'] as $cart_item) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $cart_item['date']; ?></td>
                        <td class="center"> Rs <?php echo number_format($cart_item['price'],2); ?></td>
                        <td class="center"><?php echo $cart_item['timing']; ?></td>
                        <td class="center"> Rs  <?php echo round($cart_item['price'],2); ?></td>
                    </tr>
                    <?php
                }
                ?>
                ...
                <div class="col-md-4 column">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td> RS <?php echo number_format($cart['shopping_cart']['subtotal'],2); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Shipping</strong></td>
                            <td>RS <?php echo number_format($cart['shopping_cart']['shipping'],2); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Handling</strong></td>
                            <td>RS <?php echo number_format($cart['shopping_cart']['handling'],2); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Tax</strong></td>
                            <td>RS <?php echo number_format($cart['shopping_cart']['tax'],2); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Grand Total</strong></td>
                            <td>RS <?php echo number_format($cart['shopping_cart']['grand_total'],2); ?></td>
                        </tr>
                        <tr>
