    ...
    <div class="container">
        <div class="col-lg-12 text-justify">
          <div class="address_info">
            ...
            <p>At <strong>Purnam Global Health Private Limited</strong> we are committed to offering you the best possible prices. We will be glad to meet our competitor's pricing if you ever find an item that we offer, in the same color and size, available from a similar retailer.</p>
            <p> </p>
            ...
            <p> </p>
            <p>Our merchandise/service is offered for sale by XYZ for your personal enjoyment and not for resale. Therefore, we reserve the right to refuse to sell to any person whom we believe may be purchasing for resale.</p>
            <p> </p>
            <p>Our Customer Service Specialists are ready to assist you—simply call +91 98190 35111 24 hours a day.</p>
            <p> </p>
          </div>
        </div>
    </div>
