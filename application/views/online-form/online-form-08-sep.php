...
<!-- 
            ...
            <div class="frm-row">
                ...
                <div class="section colm colm6">
                    <label class="field prepend-icon">
                        <input type="text" name="marital_since" id="marital_since" class="gui-input" placeholder="Organisation">
            ...
            <div class="frm-row">
                <div class="section colm colm6">
                    <label class="switch block">
                        ...
                        <input type="checkbox" name="sleep_day" id="sleep_day" value="1" checked>
                ...
                <div class="section colm colm6">
                    <label class="switch block">
                        ...
                        <input type="checkbox" name="wake_fresh" id="wake_fresh" value="1" checked>
                        <span class="switch-label" data-on="YES" data-off="NO"></span>
                    </label>
                </div>
            </div>
