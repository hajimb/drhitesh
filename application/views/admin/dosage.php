                            ...
                            <form class="form-horizontal" id="vform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="dosage" class="col-sm-2 control-label"><?php echo $header;?></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="dosage" name="dosage" placeholder="<?php echo $header;?>">
                                        </div>
