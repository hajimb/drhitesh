                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="allergyForm" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="allergy" class="col-sm-2 control-label">allergy Status</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="allergy" name="allergy" placeholder="10th, 12th">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <button type="submit" class="btn btn-info" id="addallergy">Add</button>
