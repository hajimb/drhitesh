                            ...
                            <form class="form-horizontal" id="vform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="industry" class="col-sm-2 control-label"><?php echo $header;?> Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="industry" name="industry" placeholder="<?php echo $header;?>">
                                        </div>
