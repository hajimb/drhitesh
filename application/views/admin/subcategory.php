                            ...
                            <form class="form-horizontal" id="vform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="cid" class="col-sm-2 control-label">Select Category  </label>
                                        <div class="col-sm-4">
                                            <?php $js = 'id="cid" class="form-control pointer"'; echo form_dropdown('cid', $category, '', $js);?>
                                            
                                        </div>
                                        <label for="subcategory" class="col-sm-2 control-label">Sub Category</label>
                                        <div class="col-sm-4">
                                           <input type="text" class="form-control" id="subcategory" name="subcategory" placeholder="Enter <?php echo $header;?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
