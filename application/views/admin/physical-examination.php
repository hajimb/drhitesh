                            ...
                            <form class="form-horizontal" id="addform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="examination" class="col-sm-2 control-label">Physical</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="examination" name="examination" placeholder="Physical Examination">
                                        </div>
