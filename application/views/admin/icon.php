                            ...
                            <form class="form-horizontal" id="vform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="iconname" name="iconname" placeholder="Enter <?php echo $header;?> Name">
                                        </div>
                                        <label for="icon" class="col-sm-2 control-label">Icon </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="icon" name="icon" placeholder="Enter <?php echo $header;?> Code">
                                        </div><br/><br/>
