                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="diseaseForm" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="disease" class="col-sm-2 control-label">disease Status</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="disease" name="disease" placeholder="10th, 12th">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <button type="submit" class="btn btn-info" id="adddisease">Add</button>
