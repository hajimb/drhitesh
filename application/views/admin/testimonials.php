                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="testmonialForm" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="category" name="category" placeholder="Female Sexual Problems : Vaginismus, Penetration Phobia">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <!-- <label for="testimonial_date" class="col-sm-2 control-label">Date</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="testimonial_date">
                                        </div> -->
