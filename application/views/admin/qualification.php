<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Qualification <small></small> </h1>
        <ol class="breadcrumb">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="QualificationForm" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="qualification" class="col-sm-2 control-label">Qualification</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="qualification" name="qualification" placeholder="10th, 12th">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <button type="submit" class="btn btn-info" id="addqualification">Add</button>
