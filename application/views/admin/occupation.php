                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal" id="OccupationForm" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="occupation" class="col-sm-2 control-label">occupation</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="occupation" name="occupation" placeholder="10th, 12th">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <button type="submit" class="btn btn-info" id="addoccupation">Add</button>
