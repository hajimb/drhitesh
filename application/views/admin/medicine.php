                            ...
                            <form class="form-horizontal" id="vform" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="medicine" class="col-sm-2 control-label">Medicine Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="medicine" name="medicine" placeholder="Medicine Name">
                                        </div>
